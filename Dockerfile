...
RUN curl -O -L https://github.com/nokia/RED/releases/download/0.7.9/RED_0.7.9.20170629090422-win32.win32.x86_64.zip
RUN curl -O -L https://github.com/nokia/RED/releases/download/0.7.7-fix/RED_0.7.7.20170427100806-win32.win32.x86_64.zip
